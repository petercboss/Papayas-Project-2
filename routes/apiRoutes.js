	...
	app.get('/', isLoggedIn, function (req, res) {
		...
		request(`http://api.openweathermap.org/data/2.5/weather?q=${req.user.city}&units=imperial&appid=b93ca65a1efb368d1b3d4a3af522cd1a`, (err, response, body) => {
			...
			request(`https://newsapi.org/v2/top-headlines?sources=bbc-news&apiKey=a49ca69ef1f34e03abdc6463849a01bf`, (err, response, body) => {
				...
				request(`https://www.thesportsdb.com/api/v1/json/1/searchteams.php?t=${req.user.sports}`, (err, response, body) => {
					...
					request(`https://www.thesportsdb.com/api/v1/json/1/eventsnext.php?id=${teamID}`, (err, response, body) => {
						...
						let allEvents = [];
						for (i = 0; i < 5; i++) {
							allEvents.push(`<div>${fiveEvents.events[i].strFilename}</div>`)
						}
...
>>>>>>> fc29a5a265b7f197b722eca8e5b4496de71fa206
